...
export default function ApplicationsPage() {
  ...
  const fetchApplications = async () => {
    const response = await fetch("/api/certificate-officer/applications");
  ...
  const handleStatusChange = async (
    ...
    const response = axios.patch("/api/certificate/update-application", {
      remark,
      status: status ? "Verified by CO" : "Rejected By CO",
      appId: appId,
      officer: "CO",
              ...
              {filteredApplications.length === 0 ? (
                ...
                filteredApplications.map((app, index) => (
                  <tr key={app._id}>
                    ...
                    <td>
                      <Link
                        href={`/certificate-officer/view-details?id=${app._id}&type=${app.type}`}
                      >
                        {app._id}
                      </Link>
                    </td>
